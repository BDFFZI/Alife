    ...
    IConfigurable<GameCompanionConfig>
{
    ...
    Editor.GameCompanionEditorController? editorController;
    ...
    {
        Monitoring.MonitorState.Stopped => "停止",
        _ => $"陪玩中 ({CurrentGame})"
    };
    ...
    protected override async Task OnAwake()
    {
        ...
        Alife.Function.GameCompanion.Screen.ScreenFrame.EnsureProcessDpiAware();
    ...
    public Task ListCompanionGames()
    {
        ...
        string state = MonitorState == Monitoring.MonitorState.Running
            ? $"陪玩中 ({CurrentGame})"
            : "未在陪玩";
        interactor.Poke($$"""
                         【已配置的游戏陪玩】
