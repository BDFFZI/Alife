...
{
    public CSharpCompiler(string[]? baseDllFiles = null)
    {
        if (baseDllFiles != null)
    ...
    public void Compile(string outputDll, string[] csFiles, string[] dllFiles)
    {
        ...
        var emitResult = compilation.Emit(outputDll, Path.ChangeExtension(outputDll, ".pdb"));
    ...
    static void AddAssemblies(List<MetadataReference> dllReferences, HashSet<string> addedDlls, string[] dllFiles)
    {
        //解析dll元数据
