...
- 深度自由扩展：插件扩展性极强，官方功能全插件化、自由开关、配有专用插件开发工具和在线插件市场。
...
打开 Alife，然后 <http://127.0.0.1:18765> 就是 alife-mcp 的服务地址。如果你不懂，没事，直接让你的 ai 接入这个 mcp 服务即可。
...
此 MCP 对 Alife 本身的 AI 同样起效！你唯一要做的就是给你的 AI 装配上 “开发者模式” 功能，然后向他发号施令吧~
...
Alife 目前尚未建立文档，你可以尝试使用 Copilot、[DeepWiki](https://deepwiki.com/BDFFZI/Alife) 之类的 AI
辅助工具，不过这些生成的资料并不准确。
